...
import (
	...
	"github.com/w3security/reconbot/brute"
	"github.com/w3security/reconbot/lib/Smuggling"
	"github.com/w3security/reconbot/lib/util"
	"github.com/w3security/reconbot/pocs_go/Springboot"
	"github.com/w3security/reconbot/pocs_go/ThinkPHP"
	"github.com/w3security/reconbot/pocs_go/apache"
	"github.com/w3security/reconbot/pocs_go/confluence"
	"github.com/w3security/reconbot/pocs_go/f5"
	"github.com/w3security/reconbot/pocs_go/fastjson"
	"github.com/w3security/reconbot/pocs_go/gitlab"
	"github.com/w3security/reconbot/pocs_go/jboss"
	"github.com/w3security/reconbot/pocs_go/jenkins"
	"github.com/w3security/reconbot/pocs_go/landray"
	"github.com/w3security/reconbot/pocs_go/log4j"
	"github.com/w3security/reconbot/pocs_go/mcms"
	"github.com/w3security/reconbot/pocs_go/ms"
	"github.com/w3security/reconbot/pocs_go/phpunit"
	"github.com/w3security/reconbot/pocs_go/seeyon"
	"github.com/w3security/reconbot/pocs_go/shiro"
	"github.com/w3security/reconbot/pocs_go/spark"
	"github.com/w3security/reconbot/pocs_go/sunlogin"
	"github.com/w3security/reconbot/pocs_go/tomcat"
	"github.com/w3security/reconbot/pocs_go/tongda"
	"github.com/w3security/reconbot/pocs_go/weblogic"
	"github.com/w3security/reconbot/pocs_go/zabbix"
	"github.com/w3security/reconbot/pocs_go/zentao"
)
...
func POCcheck(wappalyzertechnologies []string, URL string, finalURL string, checklog4j bool) []string {
	...
	if 0 < len(technologies) {
		util.SendAnyData(&map[string]interface{}{"Urls": []string{URL, finalURL}, "technologies": technologies}, util.reconbot)
	}
	return technologies
}
